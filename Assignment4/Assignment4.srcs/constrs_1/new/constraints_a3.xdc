...
# BTN1 and BTN2 for wave selection - Bank 34 so LVCMOS18
set_property PACKAGE_PIN N15  [get_ports wave_sel0]
set_property IOSTANDARD LVCMOS18 [get_ports wave_sel0]

set_property PACKAGE_PIN R18  [get_ports wave_sel1]
set_property IOSTANDARD LVCMOS18 [get_ports wave_sel1]