...
HD_PWD='C:/Users/liubo/Documents/GitHub projects/DDSP/Assignment2/stateMachine/stateMachine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_assignment2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_assignment2.tcl -notrace
