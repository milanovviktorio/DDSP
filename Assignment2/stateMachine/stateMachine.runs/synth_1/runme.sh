...
HD_PWD='C:/Users/liubo/Documents/GitHub projects/DDSP/Assignment2/stateMachine/stateMachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_assignment2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_assignment2.tcl
