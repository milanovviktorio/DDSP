...
REM
REM Generated by Vivado on Thu Mar 19 21:56:30 +0100 2026
...
echo "xvhdl --incr --relax -prj tb_stateMachine_vhdl.prj"
call xvhdl  --incr --relax -prj tb_stateMachine_vhdl.prj -log xvhdl.log
