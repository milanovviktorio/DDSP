...
REM
REM Generated by Vivado on Mon Mar 16 18:25:06 +0100 2026
...
echo "xvhdl --incr --relax -prj testbenchDatapath_vhdl.prj"
call xvhdl  --incr --relax -prj testbenchDatapath_vhdl.prj -log xvhdl.log
