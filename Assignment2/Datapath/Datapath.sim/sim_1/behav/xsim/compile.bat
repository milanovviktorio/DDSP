...
REM
REM Generated by Vivado on Sun Mar 15 22:00:44 +0100 2026
...
echo "xvhdl --incr --relax -prj testbenchPIPO_vhdl.prj"
call xvhdl  --incr --relax -prj testbenchPIPO_vhdl.prj -log xvhdl.log
