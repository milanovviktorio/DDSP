...
HD_PWD='C:/Users/liubo/Documents/GitHub projects/DDSP/Assignment3/Assignment3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FULL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FULL.tcl -notrace
