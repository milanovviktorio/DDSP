...
HD_PWD='C:/Users/liubo/Documents/GitHub projects/DDSP/Assignment3/Assignment3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FULL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FULL.tcl
